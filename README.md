...
![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/albertrml/response/publish.yml?branch=main)
![GitHub release (latest SemVer)](https://img.shields.io/github/v/release/albertrml/response)
![License](https://img.shields.io/github/license/albertrml/response)
...
dependencies {
    implementation("br.com.arml.core:response:0.1.0") // Verifique a versão mais recente
}
```
